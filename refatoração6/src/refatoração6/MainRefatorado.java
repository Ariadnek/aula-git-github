...
class SistemaVendas {
    ...
    private void apresentarTotais() {
        double totalSemDesconto = calcularTotalSemDesconto();
        double totalComDesconto = calcularTotalComDesconto();

        JOptionPane.showMessageDialog(null, "Total sem desconto: " + totalSemDesconto);
        JOptionPane.showMessageDialog(null, "Total com desconto: " + totalComDesconto);
    }
}
