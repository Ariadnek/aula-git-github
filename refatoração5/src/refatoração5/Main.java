...
public class Main {
	...
	*
	* que são inteiros. Para alterar os botões do seu dialog, crie a
	...
	*
	* DEFAULT_OPTION (apesar da documentação não deixar claro, é o OK
	* sozinho) YES_NO_OPTION YES_NO_CANCEL_OPTION OK_CANCEL_OPTION
	*/
